...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $pdo = getDatabase();
        $stmt = $pdo->prepare("UPDATE categories SET name = ?, slug = ?, description = ?, display_order = ?, status = ? WHERE id = ?");
        
        $result = $stmt->execute([$name, $slug, $description, $display_order, $status, $category_id]);
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) { .admin-container { flex-direction: column; } .admin-nav { width: 100%; } }
    </style>
</head>
<body>
            ...
            <div class="form-container">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="display_order" min="0" class="form-input" value="<?= $category['display_order'] ?>">
                    </div>
                    ...
                    <div class="button-group">
                        ...
                        <a href="delete-category.php?id=<?= $category['id'] ?>" class="btn btn-danger" onclick="return confirm('Delete this category?')">
